...
document.querySelector<HTMLElement>("#pattern_toggle")?.addEventListener("click", async (event) => {
...
document.querySelector<HTMLElement>("#clear-filters")?.addEventListener("click", async () => (
    (await import("./index")).gallery.clearFilters()
))
document.querySelector<HTMLElement>("#apply-filters")?.addEventListener("click", async () => (
